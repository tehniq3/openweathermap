 ...
 * ver.3 - add weather data using info from https://roboindia.com/tutorials/nodemcu-weather-station-arduino/
 * ver.3.1 - add base indication about wheater
*/
...
String APIKEY = "ca552950751d4b9c4a1dce2688ea68de";       //  Api key from https://openweathermap.org/   here is a fake API key                           
...
String getWeatherData()                                //client function to send/receive GET request data.
{
  if (client.connect(servername, 80))   
          ...
          client.println("GET /data/2.5/weather?id="+CityID+"&units=metric&lang=en&APPID="+APIKEY);
...
if ((cod >= 200) and (cod <= 232)) vreme = vreme + "furtuna ";
if ((cod >= 300) and (cod <= 321)) vreme = vreme + "burnita ";
